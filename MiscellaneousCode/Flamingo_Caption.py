...
for i, fn in enumerate(os.listdir(img_root)):
    ...
    answers[fn] = answer #.replace("This is a photo of")
    print(fn,answer)
    # if i == 10:
    #     break
with open("/home/liuxiao/TuringGithub/XiaoData/all_results/flamingo-4B-vitl-rpj3b-langinstruct_caption.pkl", 'wb') as f:
    pickle.dump(answers, f)
with open("/home/liuxiao/TuringGithub/XiaoData/all_results/flamingo-4B-vitl-rpj3b-langinstruct_caption.pkl", 'rb') as f:
    print(pickle.load(f))
