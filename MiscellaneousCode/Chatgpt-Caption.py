...
for fn in os.listdir(img_root):
    ...
    while (response_len > sampled_length or response_len < 6) and trial < 5:
        ...
        print("[{}]".format(trial), fn, sampled_length,response_len, response.choices[0])
        answers[fn] = ans
        trial += 1
    # break
with open('/home/liuxiao/TuringGithub/XiaoData/all_results/chatgpt_image_captioning_v3.pkl', 'wb') as f:
    pickle.dump(answers,f)
with open('/home/liuxiao/TuringGithub/XiaoData/all_results/chatgpt_image_captioning_v3.pkl', 'rb') as f:
    print(pickle.load(f))