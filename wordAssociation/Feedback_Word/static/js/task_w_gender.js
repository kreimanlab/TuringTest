...
var TurExperiment  = function() {
	...
	function mengmiClick()
	{
		...
		var combined_response = "guessis_" + guess_decision +'_' + guess_gender + "_realis_" + AI_human[random_AI_human] + "_model_" + models[random_model[0]] + "_prompt_" + current_ass  //Aclass + "___" + Agender + "___" + Aage + "___" + Bclass + "___" + Bgender + "___" + Bage
		console.log("combined response is")
		console.log(combined_response)
		if (guess_decision != null  && guess_decision.trim().length != 0 && guess_decision.indexOf(' ') < 0 && guess_gender != null  && guess_gender.trim().length != 0 && guess_gender.indexOf(' ') < 0)
		{
