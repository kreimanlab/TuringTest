...
from utils import check_input_file, encode_image, construct_confmat, findanswer, evaluate, compile_results, get_confmat, evaluateSVM
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode","-m",
                        ...
                        default="svm",
                        choices=["zs","svm"],
                        help="Select an evaluation mode: zero-shot (zs) judge or SVM judge (svm).")
    ...
    for task, responses_file_path in zip(tasks,responses_file_paths):
        ...
        check_input_file(responses_to_evaluate, task, exisiting_response_dictionary, opt.mode)
        ...
        if opt.mode == "zs":
            ...
            accuracies, avg_acc, avg_std, conf_mat = evaluateSVM(stimuli_root, exisiting_response_dictionary,task,responses_to_evaluate,opt.api_key)
